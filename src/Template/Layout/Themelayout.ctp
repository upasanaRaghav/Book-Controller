...
<html class="no-js" lang="en">
    ...
    <meta charset="utf-8">
        ...
        <link rel="shortcut icon" type="image/icon" href="webroot/logo/favicon.png"/>
			    ...
			    <nav class="navbar navbar-default bootsnav navbar-fixed dark no-background">
			        ...
			        <div class="container">
			            ...
			            <div class="navbar-header">
			                ...
			                <a class="navbar-brand" href="index.html">Upasana</a>
			            </div><!--/.navbar-header-->
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="header-text">
							<h2>Hi<span>,</span> i am <br> Upasana <br> Raghav <span>.</span>   </h2>
							<p>Software Engineer and web developer</p>
							<a href="webroot/text.txt" download>download resume</a>
						</div><!--/.header-text-->
					</div><!--/.col-->
				</div><!-- /.row-->
			</div><!-- /.container-->
				...
				<div class="about-content">
					<div class="row">
						...
						<div class="col-sm-offset-1 col-sm-5">
                            ...
                            <img src="<?=$baseurl?>webroot/img/about/profile_image.jpg" alt="profile_image">
					...
					<div class="portfolio-content">
						<div class="isotope">
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="item">
										<img src="<?=$baseurl?> webroot/img/portfolio/p1.jpg" alt="portfolio image"/>
									...
									<div class="item">
									<img src=" <?=$baseurl?> webroot/img/portfolio/p2.jpg" alt="portfolio image"/>
										<div class="isotope-overlay">
											<a href="#">
												ui/ux design
											</a>
								...
								<div class="col-sm-4">
									<div class="item">
                                    <img src=" <?=$baseurl?> webroot/img/portfolio/p3.jpg" alt="portfolio image"/>
										<div class="isotope-overlay">
											<a href="#">
												web design
											</a>
								...
								<div class="col-sm-4">
									<div class="item">
									<img src=" <?=$baseurl?> webroot/img/portfolio/p4.jpg" alt="portfolio image"/>
										<div class="isotope-overlay">
											<a href="#">
												web development
											</a>
									...
									<div class="item">
                                    <img src=" <?=$baseurl?> webroot/img/portfolio/p5.jpg" alt="portfolio image"/>
										<div class="isotope-overlay">
											<a href="#">
												web development
											</a>
			...
			<div class="clients-area">
				<div class="container">
					<div class="owl-carousel owl-theme" id="client">
						<div class="item">
							<a href="#">
							<img src=" <?=$baseurl?> webroot/img/clients/c1.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
                            <img src=" <?=$baseurl?> webroot/img/clients/c2.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
                            <img src=" <?=$baseurl?> webroot/img/clients/c3.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
							<img src=" <?=$baseurl?> webroot/img/clients/c4.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
							<img src=" <?=$baseurl?> webroot/img/clients/c5.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
							<img src=" <?=$baseurl?> webroot/img/clients/c6.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
							<img src=" <?=$baseurl?> webroot/img/clients/c7.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
					</div><!--/.owl-carousel-->
				</div><!--/.container-->
    ...
    <?= $this->Html->script('progressbar.js') ?>
